...
class AbortDelete(unittest.TestCase):
    ...
    def test_abort_delete(self):
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-21958]//*[@x-test-hook-20968]//*[@x-test-tpl-20908]//*[@x-test-tpl-20949]//*[@x-test-hook-20952]").clear()
        driver.find_element_by_xpath("//*[@x-test-tpl-21958]//*[@x-test-hook-20968]//*[@x-test-tpl-20908]//*[@x-test-tpl-20949]//*[@x-test-hook-20952]").send_keys("Dentista")
