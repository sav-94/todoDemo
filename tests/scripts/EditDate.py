...
class EditDate(unittest.TestCase):
    ...
    def test_edit_date(self):
        ...
        driver.find_element_by_xpath("//mat-form-field[3]/div/div/div[3]").click()
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-20978]//*[@x-test-hook-20988]//*[@x-test-tpl-20914]//*[@x-test-tpl-20964]//*[@x-test-hook-20973]").send_keys("6/5/2021")
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-20978]//*[@x-test-hook-20987]//*[@x-test-tpl-20956]//*[@x-test-hook-20959]").send_keys("4/5/2021")
        driver.find_element_by_xpath("//*[@x-test-tpl-20978]//*[@x-test-hook-20987]//*[@x-test-tpl-20962]//*[@x-test-hook-20963]").click()
