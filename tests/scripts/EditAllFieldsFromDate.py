...
class EditAllFieldsFromDate(unittest.TestCase):
    def setUp(self):
    ...
    def test_edit_all_fields_from_date(self):
        driver = self.driver
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21067]//*[@x-test-tpl-20967]//*[@x-test-hook-20970]").send_keys("andare a fare spesa")
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21067]//*[@x-test-tpl-20971]//*[@x-test-hook-20973]").send_keys("panini, latte")
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21067]//*[@x-test-tpl-20978]//*[@x-test-hook-20980]").send_keys("4/26/2021")
