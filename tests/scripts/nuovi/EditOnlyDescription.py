...
class EditOnlyDescription(unittest.TestCase):
    def setUp(self):
    ...
    def test_edit_only_description(self):
        driver = self.driver
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21068]//*[@x-test-tpl-20967]//*[@x-test-tpl-20978]//*[@x-test-tpl-21040]//*[@x-test-hook-21046]").send_keys(u"Martedì")
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21067]//*[@x-test-tpl-21013]//*[@x-test-hook-21015]").send_keys("carie molare")
