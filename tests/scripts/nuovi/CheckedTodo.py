...
class CheckedTodo(unittest.TestCase):
    def setUp(self):
    ...
    def test_checked_todo(self):
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-20958]//*[@x-test-hook-20968]//*[@x-test-tpl-20908]//*[@x-test-tpl-20949]//*[@x-test-hook-20955]").send_keys(u"Venerdi")
