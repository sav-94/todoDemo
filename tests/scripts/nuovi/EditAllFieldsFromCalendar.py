...
class EditAllFieldsFromCalendar(unittest.TestCase):
    ...
    def test_edit_all_fields_from_calendar(self):
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-20978]//*[@x-test-hook-20987]//*[@x-test-tpl-20953]//*[@x-test-hook-20955]").click()
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-20978]//*[@x-test-hook-20987]//*[@x-test-tpl-20949]//*[@x-test-hook-20952]").click()
