...
class EditAllFields(unittest.TestCase):
    ...
    def test_edit_all_fields(self):
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-20968]//*[@x-test-hook-20978]//*[@x-test-tpl-20908]//*[@x-test-tpl-20954]//*[@x-test-hook-20957]").send_keys("Palestra")
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-20968]//*[@x-test-hook-20978]//*[@x-test-tpl-20908]//*[@x-test-tpl-20954]//*[@x-test-hook-20960]").send_keys(u"Domani")
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-20968]//*[@x-test-hook-20977]//*[@x-test-tpl-20939]//*[@x-test-hook-20942]").click()
        driver.find_element_by_xpath("//*[@x-test-tpl-20968]//*[@x-test-hook-20977]//*[@x-test-tpl-20939]//*[@x-test-hook-20942]").clear()
        driver.find_element_by_xpath("//*[@x-test-tpl-20968]//*[@x-test-hook-20977]//*[@x-test-tpl-20939]//*[@x-test-hook-20942]").send_keys("Palestra")
        driver.find_element_by_xpath("//*[@x-test-tpl-20968]//*[@x-test-hook-20977]//*[@x-test-tpl-20943]//*[@x-test-hook-20945]").click()
        driver.find_element_by_xpath("//mat-dialog-container[@id='mat-dialog-0']/app-todo-dialog/mat-form-field/div/div").click()
        driver.find_element_by_xpath("//*[@x-test-tpl-20968]//*[@x-test-hook-20977]//*[@x-test-tpl-20943]//*[@x-test-hook-20945]").clear()
        driver.find_element_by_xpath("//*[@x-test-tpl-20968]//*[@x-test-hook-20977]//*[@x-test-tpl-20943]//*[@x-test-hook-20945]").send_keys(u"Martedì ore 18")
        driver.find_element_by_xpath("//*[@x-test-tpl-20968]//*[@x-test-hook-20977]//*[@x-test-tpl-20946]//*[@x-test-hook-20949]").click()
        driver.find_element_by_xpath("//*[@x-test-tpl-20968]//*[@x-test-hook-20977]//*[@x-test-tpl-20946]//*[@x-test-hook-20949]").clear()
