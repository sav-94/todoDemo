...
class FilterOneLabel(unittest.TestCase):
    ...
    def test_filter_one_label(self):
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21068]//*[@x-test-tpl-20967]//*[@x-test-tpl-20978]//*[@x-test-tpl-20980]//*[@x-test-hook-20983]").click()
        driver.find_element_by_xpath("//div/div[2]").click()
