...
class InsertAllFields(unittest.TestCase):
    ...
    def test_insert_all_fields(self):
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21068]//*[@x-test-tpl-20985]//*[@x-test-tpl-20994]//*[@x-test-tpl-21044]//*[@x-test-hook-21053]").click()
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21067]//*[@x-test-tpl-20971]//*[@x-test-hook-20973]").send_keys(u"Venerdì 18")
