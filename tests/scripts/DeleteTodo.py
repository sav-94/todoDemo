...
class DeleteTodo(unittest.TestCase):
    ...
    def test_delete_todo(self):
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-20938]//*[@x-test-hook-20948]//*[@x-test-tpl-20908]//*[@x-test-tpl-20929]//*[@x-test-hook-20932]").send_keys("provaeliminazione")
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-20938]//*[@x-test-hook-20948]//*[@x-test-tpl-20908]//*[@x-test-tpl-20929]//*[@x-test-hook-20935]").send_keys("prova")
        driver.find_element_by_xpath("//form/div/button/span").click()
        driver.find_element_by_xpath("//button[2]/span").click()
        driver.find_element_by_xpath("//*[@x-test-tpl-20938]//*[@x-test-hook-20948]//*[@x-test-tpl-20908]//*[@x-test-tpl-20918]//*[@x-test-hook-20927]").click()
