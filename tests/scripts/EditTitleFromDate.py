...
class EditTitleFromDate(unittest.TestCase):
    def setUp(self):
    ...
    def test_edit_title_from_date(self):
        driver = self.driver
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21067]//*[@x-test-tpl-20967]//*[@x-test-hook-20970]").send_keys("palestra")
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21067]//*[@x-test-tpl-20978]//*[@x-test-hook-20980]").send_keys("4/23/2021")
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21067]//*[@x-test-tpl-20971]//*[@x-test-hook-20973]").send_keys(u"lunedì -venerdì -sabato")
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21067]//*[@x-test-tpl-21028]//*[@x-test-hook-21031]").clear()
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21067]//*[@x-test-tpl-21028]//*[@x-test-hook-21031]").send_keys("piscina")
