...
class EditDescriptionFromDate(unittest.TestCase):
    def setUp(self):
    ...
    def test_edit_description_from_date(self):
        driver = self.driver
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21067]//*[@x-test-tpl-20971]//*[@x-test-hook-20973]").click()
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21067]//*[@x-test-tpl-20971]//*[@x-test-hook-20973]").clear()
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21067]//*[@x-test-tpl-20971]//*[@x-test-hook-20973]").send_keys(u"venerdì ore 16")
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21067]//*[@x-test-tpl-20978]//*[@x-test-hook-20980]").send_keys("4/25/2021")
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21067]//*[@x-test-tpl-21032]//*[@x-test-hook-21034]").click()
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21067]//*[@x-test-tpl-21032]//*[@x-test-hook-21034]").click()
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21067]//*[@x-test-tpl-21032]//*[@x-test-hook-21034]").clear()
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21067]//*[@x-test-tpl-21032]//*[@x-test-hook-21034]").send_keys(u"martedì ore 16")
