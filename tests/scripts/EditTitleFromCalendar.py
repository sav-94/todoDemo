...
class EditTitleFromCalendar(unittest.TestCase):
    ...
    def test_edit_title_from_calendar(self):
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21068]//*[@x-test-tpl-20967]//*[@x-test-tpl-20978]//*[@x-test-tpl-21026]//*[@x-test-hook-21035]").click()
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21067]//*[@x-test-tpl-21009]//*[@x-test-hook-21012]").send_keys("andare al parco")
