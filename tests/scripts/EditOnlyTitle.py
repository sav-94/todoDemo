...
class EditOnlyTitle(unittest.TestCase):
    ...
    def test_edit_only_title(self):
        ...
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21067]//*[@x-test-tpl-21028]//*[@x-test-hook-21031]").click()
        driver.find_element_by_xpath("//body/div").click()
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21067]//*[@x-test-tpl-21028]//*[@x-test-hook-21031]").clear()
        driver.find_element_by_xpath("//*[@x-test-tpl-21058]//*[@x-test-hook-21067]//*[@x-test-tpl-21028]//*[@x-test-hook-21031]").send_keys("Palestra")
