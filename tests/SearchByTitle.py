...
class SearchByTitle(unittest.TestCase):
    ...
    def test_search_by_title(self):
        ...
        driver.find_element_by_id("title").send_keys("prova testo per ricerca")
        driver.find_element_by_id("mat-Add_todo-Date-input").click()
        driver.find_element_by_id("mat-Add_todo-Date-input").clear()
        driver.find_element_by_id("mat-Add_todo-Date-input").send_keys("04/05/2021")
        ...
        driver.find_element_by_id("mat-input-2").send_keys("prova testo")
