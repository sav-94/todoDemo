...
class PartialInsertTodo(unittest.TestCase):
    def setUp(self):
    ...
    def test_partial_insert_todo(self):
        driver = self.driver
        ...
        driver.find_element_by_xpath(
            "//mat-dialog-container[@id='mat-dialog-0']/app-add-todo-dialog/mat-form-field[2]/div/div/div").click()
        driver.find_element_by_xpath("//mat-option[@id='mat-option-4']/span").click()
        driver.find_element_by_id("mat-input-5").click()
        driver.find_element_by_id("mat-input-5").clear()
        driver.find_element_by_id("mat-input-5").send_keys("4/20/2021")
        driver.find_element_by_xpath(
            "//mat-dialog-container[@id='mat-dialog-0']/app-add-todo-dialog/div[2]/button/span").click()
