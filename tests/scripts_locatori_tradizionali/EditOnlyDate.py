...
class EditOnlyDate(unittest.TestCase):
    ...
    def test_edit_only_date(self):
        ...
        driver.find_element_by_xpath("//mat-tab-body[@id='mat-tab-content-0-0']/div/mat-list/mat-list-item/div/button/span/mat-icon").click()
        driver.find_element_by_id("mat-input-5").click()
        driver.find_element_by_id("mat-input-5").clear()
        driver.find_element_by_id("mat-input-5").send_keys("6/5/2021")
