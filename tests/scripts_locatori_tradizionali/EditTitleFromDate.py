...
class EditTitleFromDate(unittest.TestCase):
    ...
    def test_edit_title_from_date(self):
        ...
        driver.find_element_by_name("date").send_keys("4/23/2021")
        driver.find_element_by_id("description").click()
        driver.find_element_by_id("description").clear()
        driver.find_element_by_id("description").send_keys(u"lunedì -venerdì -sabato")
        ...
        driver.find_element_by_id("title").clear()
        driver.find_element_by_id("title").send_keys("piscina")
