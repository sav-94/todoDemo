...
class EditDate(unittest.TestCase):
    ...
    def test_edit_date(self):
        ...
        driver.find_element_by_id("mat-input-2").send_keys("6/5/2021")
        ...
        driver.find_element_by_id("mat-input-5").send_keys("4/5/2021")
        driver.find_element_by_xpath("//mat-dialog-container[@id='mat-dialog-0']/app-todo-dialog/div[3]/button").click()
