...
class EditDate(unittest.TestCase):
    ...
    def test_edit_date(self):
        ...
        #driver.find_element_by_xpath("//mat-toolbar-row/button[2]").click()
        #driver.find_element_by_xpath("//div[2]/div").click()
        driver.find_element_by_xpath("//h4").click()
        
        #driver.find_element_by_name("date").send_keys("5/5/2021")
        driver.find_element_by_xpath("//mat-dialog-container[@id='mat-dialog-0']/app-todo-dialog/div[3]/button[2]").click()
        
        #driver.find_element_by_xpath("//h4").click()
        #driver.find_element_by_xpath("//mat-dialog-container[@id='mat-dialog-1']/app-todo-dialog/div[3]/button[2]").click()
