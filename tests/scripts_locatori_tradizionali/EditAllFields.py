...
class EditAllFields(unittest.TestCase):
    ...
    def test_edit_all_fields(self):
        ...
        driver.find_element_by_id("description").click()
        driver.find_element_by_id("description").clear()
        driver.find_element_by_id("description").send_keys(u"Martedì ore 18")
        driver.find_element_by_xpath("//mat-dialog-container[@id='mat-dialog-0']/app-todo-dialog/div[3]/button").click()

        driver.find_element_by_xpath("//h4").click()
        driver.find_element_by_xpath("//mat-dialog-container[@id='mat-dialog-1']/app-todo-dialog/div[3]/button").click()
