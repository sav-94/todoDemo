...
class EditDescriptionFromDate(unittest.TestCase):
    ...
    def test_edit_description_from_date(self):
        ...
        driver.find_element_by_id("description").send_keys(u"venerdì ore 16")

        driver.find_element_by_name("date").send_keys("4/25/2021")
        ...
        driver.find_element_by_id("description").send_keys(u"martedì ore 16")
