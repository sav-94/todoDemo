...
class SearchTitle(unittest.TestCase):
    ...
    def test_search_title(self):
        ...
        driver.find_element_by_id("description").send_keys("ricerca per titolo")
        
        driver.find_element_by_name("date").send_keys("6/5/2021")
        driver.find_element_by_id("Add_todo_button").click()
        time.sleep(1)

        
        driver.find_element_by_id("mat-input-2").send_keys("prova")
