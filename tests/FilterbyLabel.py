...
class FilterByLabel(unittest.TestCase):
    def setUp(self):
    ...
    def test_filter_by_label(self):
        ...
        driver.find_element_by_xpath("//mat-list-option[2]/div/div[2]").click()
        driver.find_element_by_xpath("//mat-list-option[3]/div/div[2]").click()
        ...
        driver.find_element_by_xpath("//mat-list-option[7]/div/div[2]").click()
        driver.find_element_by_xpath("//mat-list-option[8]/div/div[2]").click()
        driver.find_element_by_xpath("//mat-toolbar-row/button").click()
